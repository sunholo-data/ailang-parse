...
**OfficeDocBench** (69 files, 11 formats, 7 metrics): AILANG Parse **92.6%** composite with 100% coverage vs nearest competitor 68.0% coverage-adjusted (OfficeDocBench run of 11 August 2026). 8 parsers compared including Raw OOXML, Pandoc, Kreuzberg, MarkItDown, Unstructured, Docling. Scores include aspirational ECMA-376 spec targets that intentionally lower our score.
...
AILANG Parse v0.41.2 requires AILANG 0.35.0 or newer. They run
